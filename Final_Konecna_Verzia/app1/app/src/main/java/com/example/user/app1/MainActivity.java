...
public class MainActivity extends AppCompatActivity {
    private ImageButton mapa,  SoS, NahrajObrazok, ZaznamenajZazitok,pocasie;
    ...
    public void zaznamenaj() {
        ZaznamenajZazitok = (ImageButton)findViewById(R.id.ZaznamenajZazitok);
    ...
    public void upload() {
        NahrajObrazok = (ImageButton)findViewById(R.id.Nahraj_Obrazok);
    ...
    public void pogoda(){
        pocasie = (ImageButton)findViewById(R.id.pocasie);
